...
<nav class="navbar navbar-expand-lg navbar-light bg-light ">
  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
    ...
    <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
      ...
      <li class="nav-item" >
        <a class="nav-link" href="/j_spring_security_logout"><h2 style="color:grey"><a href="<c:url value="/j_spring_security_logout"/ ><i class="fas fa-sign-out-alt"></i>Se déconnecter </h2> <span class="sr-only">(current)</span></a>
      </li>
    </ul>
